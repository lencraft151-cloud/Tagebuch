 ...
 *
 * Nur nötig, wenn du direkt aus dem Verwaltungsbereich veröffentlichen willst.
 * Der GitHub-Token wird dann einmalig hinterlegt und mit der PIN verschlüsselt
 * im Browser gespeichert; die PIN entsperrt ihn bei jedem Öffnen.
 *
